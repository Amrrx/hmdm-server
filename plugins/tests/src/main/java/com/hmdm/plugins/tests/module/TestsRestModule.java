 ...
 * @author isv
 */
public class TestsRestModule extends ServletModule {
    ...
    protected void configureServlets() {
        ...
        this.bind(TestsRestModule.class);
    }
