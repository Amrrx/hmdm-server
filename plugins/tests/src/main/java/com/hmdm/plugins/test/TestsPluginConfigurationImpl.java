...
/**
 * <p>A configuration for <code>Tests</code> plugin.</p>
 *
 * @author isv
 */
public class TestsPluginConfigurationImpl implements PluginConfiguration {

    public static final String PLUGIN_ID = "tests";

    /**
     * <p>Constructs new <code>TestsPluginConfigurationImpl</code> instance. This implementation does nothing.</p>
     */
    public TestsPluginConfigurationImpl() {
    }
