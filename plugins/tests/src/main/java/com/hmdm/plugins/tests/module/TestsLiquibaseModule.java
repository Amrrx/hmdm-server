...
/**
 * <p>A module used for initializing and managing the state of the database tables related to <code>Tests</code>
 * plugin.</p>
 *
 * @author isv
 */
public class TestsLiquibaseModule extends AbstractLiquibaseModule {

    /**
     * <p>Constructs new <code>XtraLiquibaseModule</code> instance. This implementation does nothing.</p>
     */
    public TestsLiquibaseModule(ServletContext context) {
        super(context);
    }
    ...
    protected String getChangeLogResourcePath() {
        String path = this.getClass().getResource("/liquibase/tests.changelog.xml").getPath();
