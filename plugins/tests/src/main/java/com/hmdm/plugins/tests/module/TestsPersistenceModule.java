 ...
 * @author isv
 */
public class TestsPersistenceModule extends AbstractPersistenceModule {

    /**
     * <p>Constructs new <code>TestsPersistenceModule</code> instance.</p>
     *
     * @param context a context for usage of this module.
     */
    public TestsPersistenceModule(ServletContext context) {
        super(context);
    }
    ...
    protected String getMapperPackageName() {
        return "com.hmdm.plugins.tests.persistence.mapper";
    }
    ...
    protected String getDomainObjectsPackageName() {
        return "com.hmdm.plugins.tests.persistence.domain";
    }
